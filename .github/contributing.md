...
Firstly, thank you for taking an interesting in contributing! Fury is an
...
Fury is one of a large number of
...
issue](https://github.com/propensive/fury/issues) or contact the project
...
have commit rights to the `propensive/fury` repository, push to a branch named
...
in extreme cases. Fury does not use automatic code-formatting because it
...
Fury&rsquo;s users. Individualism is valued, and nobody should feel
